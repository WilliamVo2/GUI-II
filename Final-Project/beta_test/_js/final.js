        $(document).ready(function () {
            ...
            $(document).ready(function() {
              ...
              $('#button').click(function() {
                var $favor = $('#favorfood')
                var favorVal = $favor.val();
                if (favorVal) {
                  $('#list_food').append('<li>' + favorVal + '</li>' );
                  $favor.val('');
                  $favor.focus();
                }
              })// end click
              $('#list_food').on('click','li',function() {
                console.log($(this));
                $(this).css({
          ...
          //      }
                ...
                xhr.open("GET", "https://api.edamam.com/search?q=" + queryString + "&app_id=1b483c4a&app_key=6902c06827f835869f51edec3d9d0c71&from=0&to=7" + queryDietString, true);
                xhr.onload = function () {
